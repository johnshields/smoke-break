...
## 💾 Gameplay Boilerplate

- **Core Systems Implemented:**
    - Walking, running, jumping
    - Boost jetpack (fuel-based)
    - Melee combat and pistol shooting (ammo-based)
    - Health, stamina, fuel, and ammo management
    - Light combat with hostile drones

- **World Elements:**
    - Stylised terrain and alien flora (purple trees, red grass)
    - Basic AI enemies with pathfinding
    - Sandbox terrain for exploration and encounters
---
